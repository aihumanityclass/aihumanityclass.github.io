...
**News Team: [QuitGPT](#news-team-quitgpt)**

**Topic: [Doomerism vs. Optimism](#doomerism-vs-optimism)**

**Lead Team: [AI Impact on Jobs](#lead-team-ai-impact-on-jobs)**
...
*Figure 2: Deaths from Famines by Decade: [Our World in Data](https://ourworldindata.org/famines)*
</center>
...
<center><img src="/images/Class16Blogs/Doomerism vs Optimism.png" width=60% alt=""></img>  

*Figure 3: Doomerism vs Optimism: [CS4501: AI and Humanity](https://aihumanityclass.github.io)*
</center>

> _**The most hopeful answer is that the human species has been subjected to similar tests before and seems to have a congenital ability to come through, after varying amounts of trouble.** To ask in advance for a complete recipe would be unreasonable. We can specify only the human qualities required: **patience, flexibility, intelligence.**_<br>— John von Neumann, 1955
...
After the doomerism discussion, the lead team started with a table shuffle where three people from each table moved somewhere new followed by a couple icebreaker questions: _What was your main takeaway from the readings, and do you think we should have more leisure time built into the workweek?_ Many seemed to agree that there should be more leisure time.
